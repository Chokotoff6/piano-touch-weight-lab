    ...
    >
      ...
      {onCycleKeyFilter && (
        <button
          ...
          className={`absolute bottom-2 left-1/2 z-20 flex -translate-x-1/2 items-center rounded-full border-[1.3px] !border-green-600 bg-white font-medium !text-black hover:bg-gray-100 ${zoomed ? "gap-[0.45rem] px-[0.9rem] py-[0.225rem] text-[1.224rem]" : "gap-1 px-2 py-0.5 text-[0.68rem]"}`}
        >
